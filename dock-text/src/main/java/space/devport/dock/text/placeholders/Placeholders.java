...
import space.devport.dock.text.placeholders.parser.GeneralParser;
import space.devport.dock.text.placeholders.parser.ObjectParser;
...
public class Placeholders implements Cloneable {
    ...
    public Placeholders copy(@Nullable Placeholders placeholders) {
        ...
        // Copy cache.
        placeholders.getPlaceholderCache().forEach(placeholderCache::put);
